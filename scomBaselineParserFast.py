...
def generate_heatmaps(c1, c2, c3,  cI1, cI2, cI3):
    ...
    '''
    fig, ax = plt.subplots()
    heatmap = ax.pcolor(data1log)#, vmin=-0.21, vmax=0.08)
    cbar = plt.colorbar(heatmap)
    # put the major ticks at the middle of each cell
    ax.set_xticks(np.arange(data1log.shape[0])+0.5, minor=False)
    ax.set_yticks(np.arange(data1log.shape[1])+0.5, minor=False)
    # want a more natural, table-like display
    ax.invert_yaxis()
    ax.xaxis.tick_top()
    ax.set_xticklabels(row_labels, minor=False)
    ax.set_yticklabels(column_labels, minor=False)
    plt.savefig("complex_baseline_heatmap10A_ultimate.png")
    
    fig, ax = plt.subplots()
    heatmap = ax.pcolor(data2log)#, vmin=-0.21, vmax=0.08)
    cbar = plt.colorbar(heatmap)
    # put the major ticks at the middle of each cell
    ax.set_xticks(np.arange(data2log.shape[0])+0.5, minor=False)
    ax.set_yticks(np.arange(data2log.shape[1])+0.5, minor=False)
    # want a more natural, table-like display
    ax.invert_yaxis()
    ax.xaxis.tick_top()
    ax.set_xticklabels(row_labels, minor=False)
    ax.set_yticklabels(column_labels, minor=False)
    plt.savefig("complex_baseline_heatmap11A_ultimate.png")
    '''
    ####
    '''fig, ax = plt.subplots()
    heatmap = ax.pcolor(data3, vmin=0.0, vmax=0.35)
    cbar = plt.colorbar(heatmap)
    # put the major ticks at the middle of each cell
    ax.set_xticks(np.arange(data3log.shape[0])+0.5, minor=False)
    ax.set_yticks(np.arange(data3log.shape[1])+0.5, minor=False)
    # want a more natural, table-like display
    ax.invert_yaxis()
    ax.xaxis.tick_top()
    ax.set_xticklabels(row_labels, minor=False)
    ax.set_yticklabels(column_labels, minor=False)
    plt.savefig("complex_surf_heatmap12A_ultimate.png")
    #plt.savefig("crystalcont_surf_heatmap12A_ultimate.png")

    fig, ax = plt.subplots()
    heatmap = ax.pcolor(dataI3, vmin=0.0, vmax=0.35)
    cbar = plt.colorbar(heatmap)
    # put the major ticks at the middle of each cell
    ax.set_xticks(np.arange(data3log.shape[0])+0.5, minor=False)
    ax.set_yticks(np.arange(data3log.shape[1])+0.5, minor=False)
    ...
    ax.set_xticklabels(row_labels, minor=False)
    ax.set_yticklabels(column_labels, minor=False)
    plt.savefig("complex_intfcore_heatmap12A_ultimate.png")
    #plt.savefig("crystalcont_intfcore_heatmap12A_ultimate.png")
    ####'''
    '''
    fig, ax = plt.subplots()
    heatmap = ax.pcolor(data3log)#, vmin=-0.21, vmax=0.08)
    cbar = plt.colorbar(heatmap)
    # put the major ticks at the middle of each cell
    ax.set_xticks(np.arange(data3log.shape[0])+0.5, minor=False)
    ax.set_yticks(np.arange(data3log.shape[1])+0.5, minor=False)
    ...
    ax.set_xticklabels(row_labels, minor=False)
    ax.set_yticklabels(column_labels, minor=False)
    plt.savefig("complex_baseline_heatmap12A_ultimate.png")
    '''
    return;
...
if __name__ == "__main__":
    ...
    filename = "/home/tomi/workspace/FinalScom/out_pdbselect_compl_10-12_ultimate.txt"
    #filename = "/home/tomi/workspace/FinalScom/out_crystalcont_10-12_ultimate.txt"
    ...
    for line in infile:
        ...
        '''if (prevChain != thisChain and len(prevChain)>3):
            diff = (abs((composition1[1]+compositionI1[1])-(composition1[4]+compositionI1[4])) +
                abs((composition1[2]+compositionI1[2])-(composition1[8]+compositionI1[8])) +
                abs((composition1[3]+compositionI1[3])-(composition1[12]+compositionI1[12])) +
                abs((composition1[6]+compositionI1[6])-(composition1[9]+compositionI1[9])) +
                abs((composition1A[7]+compositionI1[7])-(composition1[13]+compositionI1[13])) +
                abs((composition1[11]+compositionI1[11])-(composition1[14]+compositionI1[14])))
            
            print prevChain + " " + str(diff)'''
    ...
    generate_heatmaps(composition1, composition2, composition3, compositionI1, compositionI2, compositionI3)
    infile.close()
