...
def calcPot(radius, type, H, P, p, n):
    ...
    if(radius == '7A'):
        ...
        if (type == 'H'):
            for i in range(0, H):
                        #ver_final2; ver_final; ver_qt; ver_new; ver_6; ver_5;  ver_4; ver_3; ver_2; ver_1, ver_October
                sum += 0.184182 #0.375094 #0.333095 #0.387099 #0.240239 #0.211227 #0.238415 #0.303159 #0.238990 #0.309556 #0.435946;
            for i in range(0, P):
                sum += 0.048272 #0.058151 #0.047514 #0.062142 #0.053656 #0.036154 #0.053411 #0.113197 #0.053223 #0.067102 #0.046302;
            for i in range(0, p):
                sum += 0.022429 #-0.085803 #-0.081367 #-0.102275 #-0.155074 #-0.147022 #-0.153545 #-0.157932 #-0.153766 #-0.188736 #-0.328980;
            for i in range(0, n):
                sum += -0.017713 #-0.203857 #-0.181453 #-0.223264 #-0.172359 #-0.139277 #-0.170240 #-0.134649 #-0.169946 #-0.179998 #-0.33622;
            if ((H+P+p+n) == 0):
                return 0.0;
            else:
                return sum / (H+P+p+n);
            ...
            for i in range(0, H):
                sum += 0.048272 #0.058151 #0.047514 #0.062142 #0.053656 #0.036154 #0.053411 #0.113197 #0.053223 #0.067102 #0.046302;
            for i in range(0, P):
                sum += -0.029229 #-0.258404 #-0.266024 #-0.270518 #-0.161026 #-0.179655 #-0.156421 #-0.057010 #-0.156863 #-0.164721 #-0.364340;
            for i in range(0, p):
                sum += -0.074664 #-0.468914 #-0.454882 #-0.496353 #-0.441194 #-0.426037 #-0.437075 #-0.418822 #-0.437517 #-0.494455 #-0.814426;
            for i in range(0, n):
                sum += -0.102679 #-0.600509 #-0.571430 #-0.655455 #-0.482182 #-0.452103 #-0.482048 #-0.410788 #-0.482361 #-0.527023 #-0.871019;
            if ((H+P+p+n) == 0):
                return 0.0;
            else:
                return sum / (H+P+p+n);
            ...
            for i in range(0, P):
                sum += -0.074664 #-0.468914 #-0.454882 #-0.496353 #-0.441194 #-0.426037 #-0.437075#-0.418822 #-0.437517 #-0.494455 #-0.814426;
            for i in range(0, p):
                sum += -0.106720 #-0.748200 #-0.699428 #-0.808914 #-0.735038 #-0.701821 #-0.740165 #-0.891226 #-0.740607 #-0.825508 #-1.333656;
            for i in range(0, n):
                sum += -0.136729 #-0.849122 #-0.793877 #-0.953323 #-0.822826#-0.756799 #-0.818326 #-0.824777 #-0.818000 #-0.885295 #-1.455513;
            if ((H+P+p+n) == 0):
                return 0.0;
            else:
                return sum / (H+P+p+n);
            ...
            for i in range(0, H):
                sum += -0.017713 #-0.203857 #-0.181453 #-0.223264 #-0.172359 #-0.139277 #-0.170240 #-0.134649 #-0.169946 #-0.179998 #-0.336223;
            for i in range(0, P):
                sum += -0.102679 #-0.600509 #-0.571430 #-0.655455 #-0.482182 #-0.452103 #-0.482048 #-0.410788 #-0.482361 #-0.527023 #-0.871019;
            for i in range(0, p):
                sum += -0.136729 #-0.849122 #-0.793877 #-0.953323 #-0.822826 #-0.756799 #-0.818326 #-0.824777 #-0.818000 #-0.885295 #-1.455513;
            for i in range(0, n):
                sum += -0.182908 #-0.940419 #-0.899644 #-1.098303 #-0.817212 #-0.760309 #-0.826452 #-0.761754 #-0.826894 #-0.889501 #-1.419626;
            if ((H+P+p+n) == 0):
                return 0.0;
            else:
                return sum / (H+P+p+n);
        ...
        if (type == 'H'):
            for i in range(0, H):
                sum += 0.191352 #0.383079 #0.341026#0.394128 #0.243201 #0.214395 #0.241859 #0.302206 #0.242364 #0.308382 #0.433586;
            for i in range(0, P):
                sum += 0.056334 #0.065033 #0.054648 #0.069393 #0.053893 #0.036746 #0.054567 #0.114499 #0.054348 #0.067675 #0.045205;
            for i in range(0, p):
                sum += 0.056334 #-0.096206 #-0.093972 #-0.110240 #-0.155534 #-0.147817 #-0.153517 #-0.157212 #-0.153647 #-0.186406 #-0.333059;
            for i in range(0, n):
                sum += -0.013680 #-0.192444 #-0.171078 #-0.215253#-0.171183 #-0.142373 #-0.171004 #-0.131142 #-0.170710 #-0.179441 #-0.333059;
            if ((H+P+p+n) == 0):
                return 0.0;
            else:
                return sum / (H+P+p+n);
            ...
            for i in range(0, H):
                sum += 0.056334 #0.065033 #0.054648 #0.069393 #0.053893 #0.036746 #0.054567 #0.114499 #0.054348 #0.067675 #0.045205;
            for i in range(0, P):
                sum += -0.035812 #-0.272483 #-0.277831 #-0.283847 #-0.161315 #-0.180651 #-0.157210 #-0.066438 #-0.157632 #-0.166830 #-0.366558;
            for i in range(0, p):
                sum += -0.084617 #-0.471129 #-0.453624 #-0.503876 #-0.428452 #-0.412480 #-0.425372 #-0.417394 #-0.425794 #-0.488858 #-0.814336;
            for i in range(0, n):
                sum += -0.109908 #-0.614191 #-0.586021 #-0.664971 #-0.480684 #-0.450437 #-0.480960 #-0.412384 #-0.481175#-0.519853 #-0.861217;
            if ((H+P+p+n) == 0):
                return 0.0;
            else:
                return sum / (H+P+p+n);
            ...
            for i in range(0, P):
                sum += -0.084617 #-0.471129 #-0.453624 #-0.503876 #-0.428452 #-0.412480 #-0.425372 #-0.417394 #-0.425794 #-0.488858 #-0.814336;
            for i in range(0, p):
                sum += -0.125730 #-0.753313 #-0.705171 #-0.806845 #-0.712257 #-0.675820 #-0.714974 #-0.865590 #-0.715397 #-0.820257 #-1.362225;
            for i in range(0, n):
                sum += -0.148075 #-0.872787 #-0.820788 #-0.977352 #-0.811247#-0.744362 #-0.804550 #-0.815465 #-0.804163 #-0.869467 #-1.445574;
            if ((H+P+p+n) == 0):
                return 0.0;
            else:
                return sum / (H+P+p+n);
            ...
            for i in range(0, H):
                sum += -0.013680 #-0.192444 #-0.171078 #-0.215253 #-0.171183 #-0.142373 #-0.171004 #-0.131142 #-0.170710 #-0.179441 #-0.333778;
            for i in range(0, P):
                sum += -0.109908 #-0.614191 #-0.586021 #-0.664971 #-0.480684 #-0.450437 #-0.480960 #-0.412384 #-0.481175 #-0.519853 #-0.861217;
            for i in range(0, p):
                sum += -0.148075 #-0.872787 #-0.820788 #-0.977352 #-0.811247 #-0.744362 #-0.804550 #-0.815465 #-0.804163 #-0.869467 #-1.445574;
            for i in range(0, n):
                sum += -0.174493 #-0.925898 #-0.883822 #-1.062325 #-0.827245 #-0.761815 #-0.834677 #-0.773669 #-0.834561 #-0.873333 #-1.434046;
            if ((H+P+p+n) == 0):
                return 0.0;
            else:
                return sum / (H+P+p+n);
        ...
        if (type == 'H'):
            for i in range(0, H):
                sum += 0.190474 #0.382330 #0.341703 #0.392413 #0.238553 #0.210319 #0.237769 #0.289144 #0.238146 #0.300254 #0.427054;
            for i in range(0, P):
                sum += 0.065051 #0.070420 #0.058219 #0.073956 #0.054798 #0.037291 #0.054648 #0.116393 #0.054428 #0.066214 #0.043497;
            for i in range(0, p):
                sum += 0.019266 #-0.094535 #-0.093727 #-0.108566 #-0.155914 #-0.148092 #-0.154412 #-0.156935 #-0.154508 #-0.188776 #-0.330881;
            for i in range(0, n):
                sum += -0.018698 #-0.189925 #-0.170336 #-0.212181 #-0.176803 #-0.149081 #-0.176758 #-0.131211 #-0.176317 #-0.183741 #-0.332487;
            if ((H+P+p+n) == 0):
                return 0.0;
            else:
                return sum / (H+P+p+n);
            ...
            for i in range(0, H):
                sum += 0.065051 #0.070420 #0.058219 #0.073956 #0.054798 #0.037291 #0.054648 #0.116393 #0.054428 #0.066214 #0.043497;
            for i in range(0, P):
                sum += -0.040836 #-0.279752 #-0.287157 #-0.288582 #-0.151473 #-0.170232 #-0.146979 #-0.066876 #-0.147420 #-0.153873 #-0.363226;
            for i in range(0, p):
                sum += -0.088993 #-0.469096 #-0.451357 #-0.500641 #-0.415833 #-0.399890 #-0.412388 #-0.408759 #-0.412829 #-0.475475 #-0.801509;
            for i in range(0, n):
                sum += -0.112841 #-0.613698 #-0.584122 #-0.662628 #-0.461089 #-0.430405 #-0.461142 #-0.399623 #-0.461411 #-0.505904 #-0.843447;
            if ((H+P+p+n) == 0):
                return 0.0;
            else:
                return sum / (H+P+p+n);
            ...
            for i in range(0, P):
                sum += -0.088993 #-0.469096 #-0.451357 #-0.500641 #-0.415833 #-0.399890 #-0.412388 #-0.408759 #-0.412829 #-0.475475 #-0.801509;
            for i in range(0, p):
                sum += -0.127955 #-0.731580 #-0.681384 #-0.789031 #-0.706595 #-0.667740 #-0.706537 #-0.865398 #-0.706978 #-0.812723 #-1.354344;
            for i in range(0, n):
                sum += -0.155250 #-0.871710 #-0.812978 #-0.975530 #-0.798633 #-0.732412 #-0.792648 #-0.807726 #-0.792407 #-0.856199 #-1.433149;
            if ((H+P+p+n) == 0):
                return 0.0;
            else:
                return sum / (H+P+p+n);
            ...
            for i in range(0, p):
                sum += -0.155250 #-0.871710 #-0.812978 #-0.975530 #-0.798633 #-0.732412 #-0.792648 #-0.807726 #-0.792407 #-0.856199 #-1.433149;
            for i in range(0, n):
                sum += -0.169206 #-0.926632 #-0.885243 #-1.059737 #-0.813558 #-0.748858 #-0.818670 #-0.756571 #-0.818226 #-0.863322 #-1.423892;
            if ((H+P+p+n) == 0):
                return 0.0;
            else:
                return sum / (H+P+p+n);
...
if __name__ == "__main__":
    ...
    #infilename = '/home/tomi/workspace/SCOM_abundance_stickiness/out_yeast_pdb_complexes_rim-core_10-12.txt';
    #infilename = '/home/tomi/workspace/idp-glob_dataset/idp-glob_dataset_g_corr.txt';
    #infilename = '/home/tomi/workspace/FinalScom/out_pdbselect_compl_10-12_ultimate.txt'
    #infilename = '/home/tomi/workspace/FinalScom/out_yeast_10-12_ultimate.txt'
    #infilename = '/home/tomi/workspace/FinalScom/out_idpcomplex2_10-12_ultimate.txt'
    infilename = '/home/tomi/workspace/FinalScom/Induced_conf_change/T50_/unbound/out_unb_T50_compl_10-12_ultimate.txt'
    #infilename = '/home/tomi/workspace/FinalScom/out_T40_10-12_ultimate.txt'
    #infilename = '/home/tomi/workspace/idp-glob_dataset/idp-glob_dataset_final_g_corr.txt'
    infile = open(infilename, 'r')
    #outfilename = '/home/tomi/workspace/SCOM_abundance_stickiness/out_yeast_pdb_complexes_rim-core_10-12_pot.txt';
    #outfilename = '/home/tomi/workspace/idp-glob_dataset/idp-glob_dataset_g_corr_pot.txt';
    #outfilename = '/home/tomi/workspace/FinalScom/out_pdbselect_compl_10-12_ultimate_pot.txt'
    #outfilename = '/home/tomi/workspace/FinalScom/out_yeast_10-12_ultimate_pot.txt'
    #outfilename = '/home/tomi/workspace/FinalScom/out_idpcomplex2_10-12_ultimate_pot.txt'
    outfilename = '/home/tomi/workspace/FinalScom/Induced_conf_change/T50_/unbound/out_unb_T50_compl_10-12_ultimate_pot.txt'
    #outfilename = '/home/tomi/workspace/FinalScom/out_T40_10-12_ultimate_pot.txt'
    #outfilename = '/home/tomi/workspace/idp-glob_dataset/idp-glob_dataset_final_g_corr_pot.txt'
